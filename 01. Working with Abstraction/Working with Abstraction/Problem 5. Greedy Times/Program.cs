...
namespace Problem_5._Greedy_Times
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] storage = Console.ReadLine().Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
            ...
            for (int i = 0; i < storage.Length; i += 2)
            {
                ...
                long count = long.Parse(storage[i + 1]);
